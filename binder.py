...
def getHexDump(execPath):
    ...
    output, error = hexdump.communicate()
    print(output)
...
def generateHeaderFile(execList, fileName, progCount):
    # The program index
    ...
    headerFile.write("\n\n#define NUM_BINARIES " +  str(progCount) - 1))
...
def main():
    ...
    generateHeaderFile(progNames, FILE_NAME, progCount)
    #generateHeaderFile(progNames, FILE_NAME)
